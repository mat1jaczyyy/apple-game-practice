...
function(_0x417268, _0x470bf3) {
    ...
    (_0x2172f1[_0x182e50(0xe1)] = function(_0x91b677, _0x5b30a1, _0x428569, _0x41e25d) {
        ...
        this[_0x444ddb(0x1e5)] = function() {
            ...
            CREATE_TEXT_ELEMENT(this, 'txTimeRemain', 0x15D, 0x195, 0x50, "center", "#2266CC");
    ...
    (_0x2172f1['fruit_box_a_006'] = function(_0x3adca8, _0x4c695f, _0x4249e9, _0xa3d797) {
        ...
        let t = this;
        function updateDarkMode(v) {
            let base = {
                "background": ["instance_1"],
                "frame": ["instance"],
                "sandboxTitle": ["mzTitle", "instance_1"]
            };
            for (const [k, e] of Object.entries(base)) {
                let i = t;
                for (const p of e) i = i[p];
                
                i.image.src = i.image.src.replace(
                    v? k : `${k}_dark`,
                    !v? k : `${k}_dark`
                );
            }
        }
        this['updateDarkMode'] = updateDarkMode,
        updateDarkMode(document.getElementById("darkMode").checked);
        this['_renderFirstFrame']();
    }
